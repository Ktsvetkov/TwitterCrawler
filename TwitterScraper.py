    ...
    def parse_tweets(items_html):
        ...
        for li in soup.find_all("li", class_='js-stream-item'):
            ...
            if date_span is not None:
                tweet['created_at'] = date_span.text
            ...
            # Tweet Hashtags
            if text_p is not None:
                tweet['hashtags'] = {tag.strip("#") for tag in text_p.get_text().split() if tag.startswith("#")}
...
if __name__ == '__main__':
    twit = TwitterSearchImpl(0, 5, 100)
    twit.search("4th Annual Natural Hair Freedom Brunch near:Atlanta")
